$(document).ready(function(){
    ...
    */
    ...
    /*
        모바일에서 1차 메뉴를 클릭하면...
            -1차메뉴에 걸려있는 naver 링크가 작동하면 안됨.
            -하위메뉴가 열려야함. (li에 open class추가)
             닫힌 1차메뉴를 클릭하면 열림, 열린 1차메뉴를 클릭하면 닫힘
             (동시에 여러개의 1차메뉴가 열림)
    */
    ...
    /*
        메뉴 열기를 클릭하면 header에 menu_open class 추가됨.
        메뉴 닫기를 클릭하면 header에 menu_open class 제거.
